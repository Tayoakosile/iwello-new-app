import {
    Box, Button, Heading, Icon, Text, VStack
...
const AboutUs = () => {
  return (
    <Box bg="#F8F5F5" as="section" pl="23px" pr="43px" py="32px">
      <VStack spacing="10px" fontSize="16px" align="flex-start">
        <Heading fontSize="24px" color="brand.500">
          About us
        </Heading>
