    ...
    <>
      <HStack align="center" onClick={onOpen}>
        <Avatar
          ...
          size="sm"
        />
        <Heading fontSize="15px">Dr. Arinola Majekodunmi</Heading>
      </HStack>
      <Drawer
        autoFocus={false}
        isOpen={isOpen}
        ...
        <DrawerContent mt="24px" w="80% !important" px="23px" h="70%">
          ...
          <HStack pt="50px" align="center" spacing="18px">
            ...
            <VStack
              ...
              as="span"
            >
              <Heading fontSize="18px" isTruncated={true} noOfLines={3} w="52">
                Dr. Arinola Majekodunmi Majekodunmi Majekodunmi
              </Heading>
...
export default DoctorRightMenu;
